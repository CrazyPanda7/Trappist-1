...
public class MapGenCavesTrappistOneC extends MapGenBaseMeta
{
                                ...
                                for (int localZ = l2; localZ < i3; localZ++)
                                {
                                    ...
                                    if (xfactorSq + zfactorSq < 1.0D)
                                    {
                                        ...
                                        if (yfactor > -0.7D && xfactorSq + yfactorSq + zfactorSq < 1.0D)
                                        {
                                        	...
                                        	if (blockIdArray[coords] == Blocks.grass && metaArray[coords] == 0 && random.nextInt(this.BREAK_THROUGH_CHANCE) == 0)
                                            {
                                                    blockIdArray[coords] = Blocks.air;
                                            }
                                            else if (blockIdArray[coords] == Blocks.dirt && metaArray[coords] == 0 || blockIdArray[coords] == Blocks.stone && metaArray[coords] == 0)
                                            {
                                                    blockIdArray[coords] = Blocks.air;
                                            }
