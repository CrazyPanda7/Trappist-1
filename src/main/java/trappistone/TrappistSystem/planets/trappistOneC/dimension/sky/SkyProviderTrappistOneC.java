package trappistone.TrappistSystem.planets.trappistOneC.dimension.sky;
...
public class SkyProviderTrappistOneC extends IRenderHandler
{
    private static final ResourceLocation sunTexture = new ResourceLocation(Core.ASSET_PREFIX, "textures/gui/celestialbodies/trappistone/TrappistOneA.png");
    ...
    public void render(float partialTicks, WorldClient world, Minecraft mc)
    {
        ...
        // Render sun
        f10 = 13.0F;
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderTrappistOneC.sunTexture);
